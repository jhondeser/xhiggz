...
const modelConfigs = {
  ...
  "web-1":    { src: "/models/web_1.glb",             scale: 0.9,  rotation: [0.15, 0.5, 0] },
  "web-2":    { src: "/models/web_2.glb",             scale: 0.9,  rotation: [0.15, 0.5, 0] },
  "web-3":    { src: "/models/web_3.glb",             scale: 0.9,  rotation: [0.5, 0.5, 0] },
...
export const modelRegistry = {
  ...
  "web-1":    buildEntry(modelConfigs["web-1"]),
  "web-2":    buildEntry(modelConfigs["web-2"]),
  "web-3":    buildEntry(modelConfigs["web-3"]),
} as const;
